...
var require_js = __commonJS({
  "node_modules/@mosowe2/js/index.js"(exports) {
    ...
    var DeepClone = function(value, map) {
      ...
      var object = Array.isArray(value) ? [] : {};
      map.set(value, object);
      Object.keys(value).forEach(function(key) {
        if (typeof value[key] !== "object") {
          object[key] = value[key];
        } else {
          object[key] = (0, exports.DeepClone)(value[key], map);
        }
      });
      return object;
    };
    ...
    var DeleteEmptyObj = function(obj) {
      var isArr = (0, exports.IsArray)(obj);
      var result = isArr ? [] : {};
      if (obj === null || obj === void 0 || obj === "")
        return result;
      for (var key in obj) {
        if ((0, exports.IsObject)(obj[key]) || (0, exports.IsArray)(obj[key])) {
          if (isArr) {
            while (obj.length > 0) {
              result.push((0, exports.DeleteEmptyObj)(obj.shift()));
            }
          } else {
    ...
    var FileDownload = function(link, name) {
      return new Promise(function(resolve) {
        return __awaiter(void 0, void 0, void 0, function() {
          var result, fileName, type, image;
          return __generator(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                image = _a.sent();
                if (image) {
                  result = (0, exports.XMLHttpRequest)(image, "".concat(fileName, ".").concat(type), "image");
                } else {
                ...
                return [3, 3];
              case 2:
                result = (0, exports.XMLHttpRequest)(link, fileName, "file");
                _a.label = 3;
              case 3:
                resolve(result);
                return [2];
      ...
      return new Promise(function(resolve, reject) {
        ...
        try {
          ...
          var Init_1 = {
            ...
            list: (0, exports.DeepClone)(config.list),
            arcWidth: 500,
            arcHeight: 500
          };
          var drawIndex_1 = 0;
    ...
    var CanvasDaubClip = function(config) {
      return new Promise(function(resolve, reject) {
        return __awaiter(void 0, void 0, void 0, function() {
          var Init_2, CanvasBox_2, Img_1, _a, _b, _c, CanvasImage_1, CtxImage_1, CanvasShade_1, CtxShade_1, CanvasOut_1, CtxOut_1, createShade_1, fillShade_1, isMouseDown_1, isMobile_1, touches_1, imageClip_1, _d;
          var _e;
          return __generator(this, function(_f) {
            switch (_f.label) {
              ...
              case 1:
                ...
                return [3, 6];
              case 2:
                if (!(typeof Init_2.image === "string" && ((_e = Init_2.image) === null || _e === void 0 ? void 0 : _e.startsWith("http"))))
                  return [3, 4];
                return [4, (0, exports.WebImageToBase64)(Init_2.image)];
              case 3:
                _c = _f.sent();
                return [3, 5];
              case 4:
    ...
    var CanvasPolygonClip = function(config) {
      return new Promise(function(resolve, reject) {
        return __awaiter(void 0, void 0, void 0, function() {
          var isMobile, Init_3, CanvasBox_3, Img_2, _a, _b, _c, CanvasImage_2, CtxImage_2, CanvasShade_2, CtxShade_2, CanvasOut_2, CtxOut_2, polygon_1, touches_2, moveTouches_1, lenTouches_1, rotateTouches_1, initLen_1, isMouseDown_2, buttonType_1, getAngle_1, imageClip_2, _d;
          var _e;
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
                ...
                Init_3 = {
                  ...
                  width: isMobile ? window.innerWidth : (config === null || config === void 0 ? void 0 : config.width) || Math.floor(window.innerWidth * 0.5),
                  height: isMobile ? window.innerHeight : (config === null || config === void 0 ? void 0 : config.height) || Math.floor(window.innerHeight),
              ...
              case 1:
                ...
                return [3, 6];
              case 2:
                if (!(typeof Init_3.image === "string" && ((_e = Init_3.image) === null || _e === void 0 ? void 0 : _e.startsWith("http"))))
                  return [3, 4];
                return [4, (0, exports.WebImageToBase64)(Init_3.image)];
              case 3:
                _c = _f.sent();
                return [3, 5];
              case 4:
              ...
              case 6:
                ...
                polygon_1 = function(ctx, bool, conf) {
                  return new Promise(function(resolve2, reject2) {
                    return __awaiter(void 0, void 0, void 0, function() {
                      var x, y, num, r, inner, rect, rectW, rectH, width, strokeStyle, startX, startY, i, newX, newY, newX1, newY1, newX, newY, img, _a2, _b2, _c2, data;
                      var _d2;
                      return __generator(this, function(_e2) {
                        switch (_e2.label) {
                          ...
                          case 1:
                            ...
                            return [3, 6];
                          case 2:
                            if (!(typeof Init_3.image === "string" && ((_d2 = Init_3.image) === null || _d2 === void 0 ? void 0 : _d2.startsWith("http"))))
                              return [3, 4];
                            return [4, (0, exports.WebImageToBase64)(Init_3.image)];
                          case 3:
                            _c2 = _e2.sent();
