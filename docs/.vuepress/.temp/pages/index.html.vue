<template><div><p><a href="https://v2.vuepress.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">基于 vuepress2.X 版本<ExternalLinkIcon/></a></p>
<blockquote>
<p>vuepress@2.X</p>
<p>vue@3.X</p>
<p>elementPlus@2.x</p>
...
<h2 id="规范-111" tabindex="-1"><a class="header-anchor" href="#规范-111" aria-hidden="true">#</a> 规范 111</h2>
<ol>
<li><code v-pre>/docs/readme.md</code>或<code v-pre>/docs/index.md</code>会被视为网站首页，其路由为<code v-pre>/</code>;</li>
<li>文件夹及 md 文件均以<code v-pre>小驼峰命名</code>；</li>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>        ---
        ...
        ---
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>注意 key-value 间的空格</strong>，生成侧边栏数据时会读取<code v-pre>.md</code>文件夹下第一行的该声明内容，若未声明，则会以文件名为左侧标题名称且排序为 0，文档搜索也是依据该格式下的 title；</p>
...
<li><code v-pre>/.vuepress/components</code>文件夹存放的是 vue3.x 组件，不会自动全局注册，需要在<code v-pre>.vuepress/client.js</code>中<code v-pre>enhance</code>下注册，可以在<code v-pre>.md</code>文件中直接使用；</li>
<li>侧边栏默认是全展开的形式；</li>
...
<p>这个组件是一个代码演示组件，类似 element 组件演示那种
<strong>注意：直接预览 md 文件不会渲染组件</strong></p>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>el-button</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>primary<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>按钮1234<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>el-button</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
...
</code></pre></div></codeShow></ClientOnly><h2 id="运行" tabindex="-1"><a class="header-anchor" href="#运行" aria-hidden="true">#</a> 运行</h2>
<p>先生成侧边栏目录：</p>
<p><code v-pre>npm run nav</code></p>
<p>会生成/utils/sidebar.js 文件，里面是侧边栏的数组</p>
<p>本地运行：</p>
